...
const contactsData = [
  ...
  { type: "Mail", data: "xyz@gmail.com", icon: <MailIcon /> },
  { type: "Linkedin", data: "Samriddhi paul", icon: <LinkedInIcon /> },
  { type: "Github", data: "SamrPaul", icon: <GitHubIcon /> },
  { type: "Insta", data: "Samriddhi Paul", icon: <InstagramIcon /> },
];
